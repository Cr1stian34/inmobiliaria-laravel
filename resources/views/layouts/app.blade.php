...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-primary shadow-ms">
            <div class="container">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                 ...
                                 <a class="dropdown-item" href="{{route('habitaciones.index')}}">
                                    {{ 'Mis publicaciónes' }}
                                </a>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse " id="categorias">
                    ...
                    <ul class="navbar-nav w-100 d-flex justify-content-between">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('categorias.show',['categoriaHabitacion'=>$categoria->id])}}">
                               {{ $categoria->nombre }}
                            </a>
                        </li>
                        @endforeach
